...
vector<int> g[100005];
int val[100005];
int nxt[100005], size[100005], p[100005], chain[100005], num[100005], csz[100005], top[100005], all = 1, cnt = 1, depth[100005];
...
ll go(int a, int b){
  ...
  while(chain[a] != chain[b]){
    ...
    if(num[a] == num[start] + csz[chain[a]] - 1)
      ...
      res = max(res, go(1, 1, n, num[start], num[a]));
    a = p[start];
  }
  if(depth[a] > depth[b]) swap(a, b);
  res = max(res, go(1, 1, n, num[a], num[b]));
  return res;
}
